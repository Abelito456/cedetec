            ...
            if($data==2){
                ...
                if($data==3){
                    ...
                    if(is_array($data_email)){
                        ...
                        $mensaje="<div style='border: 1px solid #336699!important;padding: 40px;border-radius: 5px;margin: 50px;text-align: justify;'><br><strong style='color:#336699;'>Cuenta PORTAL DE EMPLEO</strong><br><p style='color: #117a8b;font-size: 30px;'>Cambio de contraseña</p>Hemos recibido una solicitud para restablecer la contraseña de su cuenta.
                        Si usted " . $data_email["nombre"]." ha solicitado un restablecimiento de su cuenta en nuestra plataforma de PORTAL DE EMPLEO, haga clic en el enlace de abajo.<br><br> Ingresa <a href='http://membrillalpw.byethost14.com/portal_empleo/user/passresetsave?code=" . $code ."'>aquí</a>, y digite la nueva contraseña.<br>
                        <br><strong style='font-style: italic;'>Este enlace caducará en 24 horas.</strong><br><br>
                        Si no lo has solicitado, ignora este correo electrónico.<br><br> Gracias,<br>El equipo de cuentas PORTAL DE EMPLEO.</div>";
   ...
   public function actdataUser() {
    ...
    public function contacto(){
     ...
     public function enviarCorreo(){
         ...
         $email='comiteempresarialmembrillal@gmail.com';
         $nombre='Formulario de contacto PORTAL DE EMPLEO';
                    ...
                    if(empty($_POST["telefono"])){
                        ...
                        if(empty($_POST["asunto"])){
                            ...
                            if(empty($_POST["mensaje"])){
                                ...
                                if(is_array($array)){
                                    $mensaje="<div style='border: 1px solid #336699!important;padding: 40px;border-radius: 5px;margin: 50px;text-align: justify;'><br><strong style='color:#336699;'>Cuenta PORTAL DE EMPLEO</strong><br><p style='color: #117a8b;font-size: 30px;'>".$_POST["nombre"]."</p>Ha envíado un mensaje desde la plataforma PORTAL DE EMPLEO.
